...
def new_check_diff(added, revisions, i):
    ...
    if len(added) > 0:
        ...
        score = (
            len(good_words) / len(added) * (len(revisions) - i)
        )  # più tempo è passato da quando ho fatto la revisione e più vuol dire che quello che ho scritto era buono
...
if __name__ == "__main__":
    ...
    for country in countries:
        ...
        try:
            ...
            users_score, list_of_users = calculate_scores(
                differences, users_score, path_rev
            )
